    ...
    <div class="indexHeader actives">
      <div class="mid">
        <ul id="menu">
          ...
          <li data-menuanchor="page4"><a href="/#page4">我们的产品优势<i>·</i></a></li>
...
export default {
  methods: {
    show: function() {
      if($('.indexHeader').hasClass('actives')){
        $('.indexHeader').removeClass('actives')
      } else {
        $('.indexHeader').addClass('actives')
      }
    },
    moveTos: function(i) {
...
.indexHeader {
  ...
  border-image: linear-gradient(-270deg, transparent, red)10 30;
  z-index: 99;
  color: #fff !important;
  font-size: 18.67px;
  text-align: center;
